...
FASTA_DIR="$PROJECT_ROOT/openfold2_fastas"
OUTPUT_DIR="$PROJECT_ROOT/openfold2_outputs_27_5"
PRECOMPUTED_ALIGNMENT_DIR="$PROJECT_ROOT/openfold2_alignments"
MMCIF_DIR="$SHARED_DB_ROOT/AF3/alphafold3/public_databases/mmcif_files"
PARAMS_DIR="$OPENFOLD2_CODE_DIR/openfold/resources/params"
OPENFOLD_SCRIPT="$OPENFOLD2_CODE_DIR/run_pretrained_openfold.py"
